            ...
            <div class=" flex-col md:flex-row hidden md:block -mx-2">
                ...
                <div id="dropdownHover" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton">
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-gray-100 text-gray-900">Sản phẩm</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#" class="block px-4 py-2 hover:bg-gray-100 text-gray-900">Thương hiệu - Loại</a>
                        </li>
                        <li>
