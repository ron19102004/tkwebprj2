        ...
        <div class="md:flex items-center justify-between py-2 px-8 md:px-12">
            <div class="flex justify-between items-center">
                <div class="text-2xl font-bold text-gray-800 md:text-3xl">
                    <a href="/"><?php echo Helper::env('app_name') ?> Admin</a>
                </div>
                <div class="md:hidden">
            ...
            <span class="hidden md:block font-bold" id="list-menu">
                <div class=" flex-col md:flex-row flex -mx-2">
                    ...
                    <div id="dropdownHover" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton">
                            <li>
                                <a href="<?php echo Helper::pages('admin/product.php'); ?>" class="block px-4 py-2 hover:bg-gray-100 text-gray-900">Sản phẩm - Số lượng</a>
                            </li>
                            <li>
