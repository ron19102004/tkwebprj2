...
<header class="w-full">
    <nav class="bg-white shadow-lg">
        <div class="md:flex items-center justify-between py-2 px-8 md:px-12">
            ...
            <span class="md:block hidden" id="list-menu">
                <div class=" flex-col md:flex-row flex md:block -mx-2">
                    ...
                    <a href="<?php echo Helper::pages('product.php');?>" class="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">Sản phẩm</a>
