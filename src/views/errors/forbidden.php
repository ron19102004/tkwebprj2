  ...
  <style>
    ...
    *:after {
    ...
    .overlay:nth-of-type(1):focus~.lock {
      ...
      transform: translateY(-3px) translateX(5px) rotateX(-13deg) rotateY(3deg) rotateZ(-2deg) translateZ(0) scale(0.89);
    }

    .overlay:nth-of-type(1):hover~.bg-403,
    .overlay:nth-of-type(1):focus~.bg-403 {
      transform: translateX(-27%) skewY(-3deg) rotateX(-13deg) rotateY(3deg) translateZ(-100px) scale(0.89);
    }
    ...
    .overlay:nth-of-type(3):focus~.lock {
      ...
      transform: translateY(3px) translateX(-5px) rotateX(-13deg) rotateY(3deg) rotateZ(-2deg) translateZ() scale(0.96);
    }
  ...
  <div class="scene">
    ...
    <div class="text">
      ...
      <span class="support">
        ...
        <a href="<?php echo Helper::pages('home.php');?>">Home</a>
      </span>
    </div>
    <div class="lock"></div>
  </div>
